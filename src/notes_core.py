...
class Note:
    ...
    def __repr__(self):
        ...
        return "Note: (Title: {}Tags: {}Description: {})".format(
            self.title, tags_str, self.description
        )
...
class Notebook:
    ...
    def put_notes_in_stringlist(notes):
        ...
        for note in notes:
            ...
            table.append(
                ...
                + ",".join(
                    [
                        (Fore.CYAN + "#" + tag.name + Style.RESET_ALL)
    ...
    def search_notes_by_text(self, text):
        ...
        for note in self.notes:
            if (
                ...
                or text.lower() in note.description.lower()
            ):
                matching_notes.append(note)
    ...
    def load_json(cls, filename):
        ...
        for note_data in data["notes"]:
            ...
            tags = [
                Tag(tag_name) for tag_name in note_data["tags"]
            ]  # Создаем объекты Teg
